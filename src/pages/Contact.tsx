    ...
    <div className="w-full pt-20 bg-gray-50 min-h-screen text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Contact Form */}
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 flex flex-col justify-center">
            {isSubmitted ? (
        ...
        <div className="mt-16 bg-white p-4 rounded-3xl shadow-lg border border-gray-100 h-[450px] overflow-hidden">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1154.2188289569!2d77.64582570000001!3d25.4139719!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39771b0028df1d9d%3A0xdc3513f76fc73254!2sFatehpur%20Chauraha%20Shivpuri!5e0!3m2!1sen!2sin!4v1712739000000!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
